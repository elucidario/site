...
export default function Page() {
    ...
    return (
        <>
                    ...
                    >
                        ...
                        >
                            <Text>
                                ...
                                Engenharia de Software pela USP, dedica sua
                                pesquisa ao desenvolvimento de soluções que
                                facilitam a organização, o acesso e a
                                distribuição da informação em instituições
                                culturais, culminando na criação do{" "}
                                <strong>
                                    Modelo de Dados para Organização e
                                    Representação da Informação Museológica
                                </strong>{" "}
                                (MDORIM), a espinha dorsal do{" "}
                                <strong>elucidario.art</strong>. Com
                                pós-graduação em Comunicação e Design Digital
                                pela ESPM-SP e bacharelado em Artes Visuais pela
                                Belas Artes, agrega ao projeto uma sensibilidade
                                estética e funcional, garantindo uma experiência
                                de usuário intuitiva e envolvente.{" "}
                            </Text>
                            <Text>
                                Com experiência em desenvolvimento de projetos
                                digitais, a frente da comunicação da Casa Museu
                                Ema Klabin por mais de 10 anos, criou diversos
                                projetos incluindo o{" "}
                                <Link
                                    target="_blank"
                                ...
                                que integra conhecimento técnico em
                                desenvolvimento de software com expertise em
            ...
            <Footer
                cta={{ label: "Quero novidades!", href: "#cta-newsletter" }}
            />
        </>
    );
}
